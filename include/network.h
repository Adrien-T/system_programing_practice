    ...
    // Connections:
        ...
        // connect is the connection we wish to close
        void close_connection(connection_t *connect);

        // handle_connection_ends
        // checks the status of each connection and closes the ones that need changing
        // connect is the linked list of all your connections
